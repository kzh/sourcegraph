...
import { CodeView, ResolvedCodeView } from '../code_intelligence/code_views'
 ...
 */
const singleFileSourceCodeView: CodeView = {
    getToolbarMount,
 ...
 */
const singleFileDiffCodeView: CodeView = {
    ...baseDiffCodeView,
 ...
 */
const pullRequestDiffCodeView: CodeView = {
    ...baseDiffCodeView,
 ...
 */
const compareDiffCodeView: CodeView = {
    ...baseDiffCodeView,
 ...
 */
const commitDiffCodeView: CodeView = {
    ...baseDiffCodeView,
...
export const bitbucketServerCodeHost: CodeHost = {
    ...
    codeViewSpecResolvers: [codeViewSpecResolver],
